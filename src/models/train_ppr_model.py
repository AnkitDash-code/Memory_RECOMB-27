"""Training loop for the PPR memory propagation model."""
...
from src.models.ppr_memory_layer import PPRMemoryAutoencoder
...
def train_ppr_model(
    ...
    """Train PPRMemoryAutoencoder on a preprocessed AnnData."""
    set_seed(seed)
        ...
        if epoch % log_every == 0 or epoch == epochs - 1:
            ...
            if verbose:
                print(
                    ...
                    f"slots_used={n_slots_used:2d}  alpha={alpha:.3f}"
                )
    ...
    adata.obsm["X_ppr"] = embedding.cpu().numpy()
